...
`diff MyMarkdownParse.txt CommonMarkOutput.txt > diff.txt`
...
provided implementation were quite similar. However, there were some cases that stuck out in which
the provided implementation differed from mine. 

## Step 2 - Test Case 22.md

For this test case, my implementation returned nothing while the provided implementation returned
the following.
...
For this test case, my implementation returned nothing while the provided implementation returned the following.
